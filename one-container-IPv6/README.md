...
IPv6 communication is enabled in this version. This requires a **native** IPv6 connection to the internet either using DS or DS lite. Furthermore IPv6 should be [enabled in Docker](https://docs.docker.com/config/daemon/ipv6/).
...
| `ServerIPv6: <Host's IPv6>`<br/> | **--net=host mode requires** Set to your server's LAN IPv6, used by web block modes and lighttpd bind address
